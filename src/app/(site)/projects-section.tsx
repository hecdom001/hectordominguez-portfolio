    ...
    return (
        <Section id="projects">
            <div className="flex items-end justify-between mb-4">
                ...
                <Button variant="ghost" className="rounded-full" onClick={() => window.open("https://github.com/your-username?tab=repositories","_blank")}>See all</Button>
            </div>
                        ...
                        <CardHeader>
                            <CardTitle className="flex items-center justify-between">
                                ...
                                {p.title === "CoachFlow" ? (
                                    ...
                                    <span className="text-[11px] text-muted-foreground/80 px-2 py-0.5 rounded-full border">Project</span>
                                )}
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex gap-2 pt-2">
                                {p.links.map((l:any, i:number) => (
                                    <Button key={i} asChild size="sm" variant={i===0?'default':'outline'} className="rounded-full">
